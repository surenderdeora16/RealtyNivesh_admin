...
const EditRetreat = () => {
    ...
    const [initialValues, setInitialValues] = useState({
        ...
        status: "",
        prices: [
            { occupancy_type: 1, currency: 1, amount: "" },
            { occupancy_type: 2, currency: 1, amount: "" },
            { occupancy_type: 3, currency: 1, amount: "" },
            { occupancy_type: 1, currency: 2, amount: "" },
            { occupancy_type: 2, currency: 2, amount: "" },
            { occupancy_type: 3, currency: 2, amount: "" }
        ],
        details: "",
    });
    ...
    const fields = [
        ...
        { label: "Image", name: "image", type: "file", col: 6 },
        {
            label: "Status", name: "status", type: "select2", options: [
                { id: 1, name: "Sold Out" },
                { id: 2, name: "Past" },
                { id: 3, name: "Upcoming" }
            ], col: 6
        },
        { label: "Pricing :", type: "line" },
